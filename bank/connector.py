...
class WeryfikatorConnector:
    ...
    async def generate_token(self, domain: str, ttl_seconds: int | None = None) -> str:
        """
        Generate a token from the weryfikator service.
        ...
        try:
            ...
            response = await self._client.post('/generate-token', json=payload)
